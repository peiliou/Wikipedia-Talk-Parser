...
(function () {
	...
	replyButtons.forEach(button => button.addEventListener('click', async (e) => {
		...
		const reply_widget = await wait_element(".ext-discussiontools-ui-replyWidget");
		register_handler(reply_widget, "input", cont_callback);

		console.log(res);
		console.log(metadata);
	}));

	const register_handler = (el, type, func) => {
